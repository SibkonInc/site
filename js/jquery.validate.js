...
jQuery.extend(jQuery.validator, {
	...
	messages: {
		...
		maxlength: jQuery.format("Более {0} знаков."),
		maxLength: jQuery.format("Не более {0} знаков."),
		minlength: jQuery.format("Не менее {0} знаков."),
		minLength: jQuery.format("Менее {0} знаков."),
		rangelength: jQuery.format("между {0} и {1} знаков ."),
		rangeLength: jQuery.format("между {0} и {1} знаков ."),
		rangeValue: jQuery.format("между {0} и {1} знаков ."),
		range: jQuery.format("от {0} до {1}  ."),
