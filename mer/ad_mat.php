...
<p>
	...
	";
			echo "<h3 align = \"center\">Добавление Материала к $name</h3>";
		echo "
<form name=\"form1\" method=\"post\" action=\"$site/mer/ad_mat_post.php?id=$id\">
<table>
...
<span class=\"ncc\"><a href=\"javascript:document.form1.submit()\">Добавить материал</a></span> 
